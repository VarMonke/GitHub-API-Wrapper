...
latex_documents = [
    ("index", "Github-API-Wrapper.tex", "Github-API-Wrapper Documentation", "VarMonke, sudosnok & contributors", "manual"),
]
...
man_pages = [("index", "Github-API-Wrapper", "Github-API-Wrapper Documentation", ["VarMonke, sudosnok & contributors"], 1)]
